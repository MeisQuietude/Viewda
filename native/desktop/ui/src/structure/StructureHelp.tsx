...
const HELP = {
  ...
  "Stats & bloom":
    "In the chunk map, color shows whether each chunk has statistics and a separate dot marks a bloom filter. For example, either can help a reader skip data for a selective filter.",
} as const;
